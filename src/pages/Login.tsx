                    ...
                    <div className= {`flex ${isMobileDevice ? 'flex-col': 'flex-row'}`}>
                            <div className={` ${isMobileDevice ? 'w-full mt-4' : 'w-1/3 mt-10' }`}>
                                ...
                                <div className={`flex flex-col mr-2 ${isMobileDevice ? "mt-6 mr-0" : 'mt-10'}`}>
                                    ...
                                    <button
                                       className="text-center mt-4 h-14 w-100 flex items-center justify-center gap-3 rounded-full bg-[#1C1A1C] cursor-pointer transition-all duration-450 ease-in-out hover:bg-gradient-to-t hover:from-purple-400 hover:to-purple-600 hover:shadow-[inset_0px_1px_0px_rgba(255,255,255,0.4),inset_0px_-4px_0px_rgba(0,0,0,0.2),0px_0px_0px_4px_rgba(255,255,255,0.2),0px_0px_180px_#9917FF] hover:-translate-y-1"
                                    ...
                                    >
                                     <svg
                                       ...
                                       data-name="Layer 1"
                                       id="Layer_1"
                                       className="sparkle transition-transform duration-800 ease hover:scale-120 hover:fill-white"
                                     >
                                       <path d="M10,21.236,6.755,14.745.264,11.5,6.755,8.255,10,1.764l3.245,6.491L19.736,11.5l-6.491,3.245ZM18,21l1.5,3L21,21l3-1.5L21,18l-1.5-3L18,18l-3,1.5ZM19.333,4.667,20.5,7l1.167-2.333L24,3.5,21.667,2.333,20.5,0,19.333,2.333,17,3.5Z"></path>
                                      </svg>
                                    <span className="text font-semibold text-[#AAAAAA] text-medium transition-all duration-450 ease-in-out hover:text-white">
